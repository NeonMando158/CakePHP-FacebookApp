<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('FacebookUser', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Admin Edit %s', __('Facebook User')); ?></legend>
				<?php
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FacebookUser.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FacebookUser.id'))); ?></li>
