...
class FacebookAppAuthenticate extends BaseAuthenticate {
	...
	public function authenticate(CakeRequest $request, CakeResponse $response) {
		...
		if ($this->_sessionRead('decoded_request.user_id') && $this->_sessionRead('decoded_request.oauth_token')) {
			$access_token = $this->_sessionRead('decoded_request.oauth_token');
		}
	...
	protected function _getAccessToken($code) {
		...
		$response = $this->http->get('https://graph.facebook.com/oauth/access_token', $query);
		$params = null;
	...
	protected function _getFBUserData($access_token) {
		...
		$response = $this->http->get('https://graph.facebook.com/me', $query);
